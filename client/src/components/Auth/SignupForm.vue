    ...
    <div class="container mx-auto">
      <div class="flex flex-wrap -mx-4">
        <div class="w-full px-4">
          <div
            class="relative mx-auto max-w-[630px] overflow-hidden rounded-lg bg-white py-16 px-10 text-center sm:px-12 md:px-[60px] dark:bg-dark-2"
          >
            ...
            <form>
              <div class="flex space-x-4 mb-6">
                <input
                  ...
                  class="w-1/2 px-5 py-3 text-base bg-transparent border rounded-md outline-none border-stroke text-body-color dark:text-white dark:border-dark-3 focus:border-primary focus-visible:shadow-none"
                />
                <input
                  type="text"
            ...
            <p class="mb-6 text-base text-body-color dark:text-dark-6">Or Sign up with</p>
            <ul class="flex justify-between mb-12 -mx-2">
              ...
              <a href="javascript:void(0)" class="text-primary hover:underline"> Sign In </a>
