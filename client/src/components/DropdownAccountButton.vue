      ...
      <div class="flex justify-center">
        <div ref="domNode" class="relative inline-block">
          <button
            ...
            class="inline-flex h-12 items-center justify-center gap-2 rounded-lg border border-stroke bg-white px-6 py-3 text-base font-medium text-dark dark:border-dark-3 dark:bg-dark-2 dark:text-black"
          >
            Account
          ...
          <div
            v-show="dropdownOpen"
            class="absolute right-0 mt-2.5 w-[240px] divide-y divide-stroke overflow-hidden rounded-lg dark:divide-dark-3 dark:bg-red-500"
          >
            <div class="px-4 py-3">
              <p class="text-sm font-semibold text-dark dark:text-black">Account menu</p>
            </div>
            <div>
              <a
                href="javascript:void(0)"
                class="flex w-full items-center justify-between px-4 py-2.5 text-sm font-medium text-dark hover:bg-gray-50 dark:text-black dark:hover:bg-white/5"
              >
